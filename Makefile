...
.PHONY: eslint_inspect
eslint_inspect: ./node_modules/.package-lock.json ./package.json ./package-lock.json ./eslint.config.js
	npm exec --no --ignore-scripts -- eslint --inspect-config
...
node_test: ./node_modules/.package-lock.json ./package.json ./package-lock.json
	node --test --experimental-test-coverage --test-coverage-include='src/**/*.js' --test-coverage-lines=95 --test-coverage-branches=100 --test-coverage-functions=95
